...
// "person". actor rolls up only that author's time ("" sums everyone's; pass
// your own handle for a mine-only view).
func (c Client) Gantt(from, to, by, actor string) (*Gantt, error) {
